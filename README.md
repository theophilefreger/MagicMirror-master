...
2. Clone the repository and check out the master branch: `git clone https://github.com/theophilefreger/MagicMirror-master.git`
3. Enter the repository: `cd ~/MagicMirror-master`
